...
router.get('/rates/status', verifyToken, chickenController.getRateStatus);
...
router.put('/markups/:id', verifyToken, checkRole(['manager', 'owner']), chickenController.updateMarkupRule);
router.delete('/markups/:id', verifyToken, checkRole(['manager', 'owner']), chickenController.deleteMarkupRule);
...
router.get('/bills/summary', verifyToken, chickenController.getBillSummary);
